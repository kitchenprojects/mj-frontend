...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-20 flex flex-col items-center justify-center text-center min-h-[60vh]">
        <div className="w-20 h-20 rounded-full flex items-center justify-center mb-6" style={{ background: 'linear-gradient(135deg, #E6F7F6 0%, #F0F7F7 100%)' }}>
          <span className="material-symbols-outlined text-[40px]" style={{ color: '#03BEB0' }}>shopping_cart</span>
        </div>
        <h1 className="text-2xl font-bold text-gray-800 mb-2">Keranjang Kosong</h1>
        <p className="text-gray-500 mb-6">Anda belum menambahkan item ke keranjang.</p>
        <Link
          to="/menu"
          className="flex items-center gap-2 px-6 py-3 text-white font-semibold rounded-xl transition-all hover:opacity-90"
